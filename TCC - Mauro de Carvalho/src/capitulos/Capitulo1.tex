...
A Escola Virtual do Governo (\abrv[EV.G - Escola Virtual do Governo]{EV.G}) foi pensada como uma das iniciativas criadas pela Escola Nacional de Administração Pública (\abrv[ENAP - Escola Nacional de Administração]{ENAP}), junto a escolas de governo e outras instituições parceiras.
...
Nesse contexto de atendimento massivo e na dificuldade de construir e manter uma central de atendimento, foi desenvolvido um \textit{chatbot} de conversação textual para a plataforma mensagens instantâneas chamada  Telegram, denominado de \abrv[EVA - EV.G Virtual Assistant]{EVA} (EV.G \textit{Virtual Assistant}).
