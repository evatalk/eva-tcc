...
A Escola Virtual de Governo (\abrv[EV.G - Escola Virtual do Governo]{EV.G}) foi pensada como uma das iniciativas criadas pela Escola Nacional de Administração Pública (\abrv[ENAP - Escola Nacional de Administração Pública]{ENAP}), junto a escolas de governo e outras instituições parceiras.
