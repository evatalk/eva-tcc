...
\begin{table}[htb!]
\textsf{\caption{Especificação dos casos de uso de EVA}}
\center
\footnotesize
\begin{tabular}{|p{2cm}|p{3cm}|p{7.5cm}|}
  \hline
