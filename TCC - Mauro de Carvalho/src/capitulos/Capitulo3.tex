...
\subsubsection{Cenário UC01 - Dialogar com EVA}
\subsubsection{Cenário UC02 - Efeuar login}
\subsubsection{Cenário UC03 - Visualizar histórico escolar completo}
\subsubsection{Cenário UC04 - Receber auxílio na emissão de certificados}
\subsubsection{Cenário UC05 - Visualizar inscrições de cursos abertos}
\subsubsection{Cenário UC06 - Efetuar logout}
